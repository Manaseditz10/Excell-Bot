    ...
    async selectMenuHandle(interaction) {
        try {
            ...
            const embed = this.client.util.embed()
                ...
                if (funny === 'antinuke') {
                    ...
                    if (joinedCmdList.length <= 1024) {
                        embed1.addFields({ name: `**${emojis.antinuke} Antinuke \`[${cmdList.length}]\`**`, value: joinedCmdList });
                        ...
                        embed1.addFields({ name: `**${emojis.antinuke} Antinuke \`[${half}]\`**`, value: firstHalf });
                        embed2.addFields({ name: `**${emojis.antinuke} Antinuke \`[${cmdList.length - half}]\`**`, value: secondHalf });
            ...
            if (funny === 'moderation') {
                    ...
                    const joinedCmdList = cmdList.sort().join(', ');
                    if (joinedCmdList.length <= 1024) {
                        embed1.addFields({ name: `**${emojis.moderation} Moderation \`[${cmdList.length}]\`**`, value: joinedCmdList });
                        interaction.reply({ embeds: [embed1], ephemeral: true });
                    } else {
                        const half = Math.ceil(cmdList.length / 2);
                        const firstHalf = cmdList.slice(0, half).join(', ');
                        ...
                        embed1.addFields({ name: `**${emojis.moderation} Moderation \`[${half}]\`**`, value: firstHalf });
                        embed2.addFields({ name: `**${emojis.moderation} Moderation \`[${cmdList.length - half}]\`**`, value: secondHalf });
            ...
            if (funny === 'automod') {
                ...
                embed.addFields({
             name :  `**<:automod:1374270757752012850> Automod \`[${cmdList.length}]\`**`,
            ...
            if (funny === 'logger') {
                ...
                embed.addFields({
                   name : `**<:logger:1374270588998123631> Logging \`[${cmdList.length}]\`**`,
                    value : cmdList.sort().join(', ')
            })
                interaction
                    .reply({
            ...
            if (funny === 'utility') {
                ...
                embed.addFields({
                   name : `**<:utility:1374271716896800870>  Utility  \`[${cmdList.length}]\`**`,
                  value :  cmdList.sort().join(', ')
            })
                interaction
                    .reply({
            ...
            if (funny === 'serverutility') {
                ...
                embed.addFields({
             name :  `**<:Serverconfig:1374592196124086372> Server Utility \`[${cmdList.length}]\`**`,
                value :    cmdList.sort().join(', ')
            })
                await interaction
                .reply({
            ...
            if (funny === 'verification') {
                ...
                embed.addFields({
                   name : `**<:Verification:1374592156853076011> Verification \`[${cmdList.length}]\`**`,
                value :    cmdList.sort().join(', ')
            })
                interaction
                    .reply({
            ...
            if (funny === 'jointocreate') {
                ...
                embed.addFields({
                  name :  `**<:j2c:1374248018022502461> Join To Create \`[${cmdList.length}]\`**`,
                   value : cmdList.sort().join(', ')
            })
                await  interaction
                .reply({
            ...
            if (funny === 'voice') {
                ...
                embed.addFields({
                  name :  `**<:voice:1374271279733018654> Voice \`[${cmdList.length}]\`**`,
                   value : cmdList.sort().join(', ')
            })
                await  interaction
                .reply({
            ...
            if (funny === 'customrole') {
                ...
                embed.addFields({
                  name :  `**<:customrole:1374271961131253821> Customrole \`[${cmdList.length}]\`**`,
                   value : cmdList.sort().join(', ')
            })
                await  interaction
                .reply({
            ...
            if (funny === 'welcomer') {
                ...
                embed.addFields({
                  name :  `**<:welcomer:1374270100718227457> Welcomer \`[${cmdList.length}]\`**`,
                   value : cmdList.sort().join(', ')
            })
                await  interaction
                .reply({
            ...
            if (funny === 'autoresponder') {
                ...
                embed.addFields({
                  name :  `**<:Auto:1374592179888197632> Auto Responder \`[${cmdList.length}]\`**`,
                   value : cmdList.sort().join(', ')
            })
                await  interaction
                .reply({
            ...
            if (funny === 'sticky') {
                ...
                embed.addFields({
                  name :  `**<:Sticky:1374592210443698306>  Sticky \`[${cmdList.length}]\`**`,
                   value : cmdList.sort().join(', ')
            })
                await  interaction
                .reply({
         ...
         if(funny === 'ticket') {
            ...
            const joinedCmdList = cmdList.sort().join(', ');
            if (joinedCmdList.length <= 1024) {
                embed1.addFields({ name: `**<:t1cket:1374248025093963776> Ticket \`[${cmdList.length}]\`**`, value: joinedCmdList });
                interaction.reply({ embeds: [embed1], ephemeral: true });
            } else {
                const half = Math.ceil(cmdList.length / 2);
                const firstHalf = cmdList.slice(0, half).join(', ');
                ...
                embed1.addFields({ name: `**<:t1cket:1374248025093963776> Ticket \`[${half}]\`**`, value: firstHalf });
                embed2.addFields({ name: `**<:t1cket:1374248025093963776> Ticket \`[${cmdList.length - half}]\`**`, value: secondHalf });
